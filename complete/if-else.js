...
Which is to say: if you want to enter Britain, the simplest way is to present a
British passport.

*/
//complete the condition so you can be welcomed in Britain

let yourPassport = "British";
let requiredPassport = "British";

if (/*code here*/) {
  console.log("Welcome in Britain!");
} else {
  console.log("You're in the wrong country");
}
